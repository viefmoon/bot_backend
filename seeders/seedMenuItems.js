...
const menu = [
  ...
  },
  {
    ...
    category: "bebidas",
    productVariants: [
      { id: "REF-V-1", name: "Coca Cola", price: 30 },
      { id: "REF-V-2", name: "7up", price: 30 },
      { id: "REF-V-3", name: "Mirinda", price: 30 },
      { id: "REF-V-4", name: "Refresco de Sangría", price: 30 },
      { id: "REF-V-5", name: "Agua Mineral", price: 30 },
      { id: "REF-V-6", name: "Squirt", price: 30 },
    ],
  },
  {
    id: "SP",
  ...
  },
  {
    ...
    category: "bebidas",
    productVariants: [
      { id: "CC-V-1", name: "Cafe Americano", price: 45 },
      { id: "CC-V-2", name: "Capuchino", price: 45 },
      { id: "CC-V-3", name: "Chocolate", price: 50 },
      { id: "CC-V-4", name: "Mocachino", price: 45 },
      { id: "CC-V-5", name: "Latte Vainilla", price: 45 },
      { id: "CC-V-6", name: "Latte Capuchino", price: 45 },
    ],
  },
  {
    id: "F",
