...
export enum ErrorCode {
  ...
  MODIFIER_GROUP_REQUIRED = 'VAL011',
  MODIFIER_SELECTION_COUNT_INVALID = 'VAL012',
  PIZZA_CUSTOMIZATION_REQUIRED = 'VAL013',
  INVALID_PIZZA_CONFIGURATION = 'VAL014',
  VARIANT_REQUIRED = 'VAL015',
  ITEM_NOT_AVAILABLE = 'VAL016',
  MULTIPLE_VALIDATION_ERRORS = 'VAL017',
  MINIMUM_ORDER_VALUE_NOT_MET = 'VAL018',
