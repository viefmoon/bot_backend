...
import { Customer, PreOrder } from "../../database/entities";
import * as dotenv from "dotenv";
import { preProcessMessages } from "../../common/utils/messageProcess";
import { PreOrderService } from "../../orders/pre-order.service";
import logger from "../../common/utils/logger";
import { AgentConfig, AgentType } from "../../common/types/agents";
dotenv.config();
