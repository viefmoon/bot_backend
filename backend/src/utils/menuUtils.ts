...
interface ProductoInfo {
  ...
  export async function getMenuForAI(): Promise<string | { error: string; detalles?: string }> {
    try {
      ...
      // Convertir a string y reemplazar los caracteres escapados
      const jsonString = JSON.stringify(menuForAI);
