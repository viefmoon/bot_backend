  ...
  const systemMessageForPreprocessing = {
    ...
    content: JSON.stringify({
      instructions: [
        ...
        "Si un cliente solicita un ingrediente que no existe en el menú o que no es aplicable al producto solicitado (no se encuentra dentro del objeto del producto seleccionado por el cliente), informa que el ingrediente no está disponible.",
        "Si un cliente solicita un producto que no está en el menú disponible, infórmale amablemente que puede revisar el menú completo en el catálogo ubicado en la esquina superior derecha de WhatsApp.",
