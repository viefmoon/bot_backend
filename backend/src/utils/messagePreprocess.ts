  ...
  const systemMessageForPreprocessing = {
    ...
    content: JSON.stringify({
      instructions: [
        ...
        "Si un cliente solicita un ingrediente que no existe en el menú o que no es aplicable al producto solicitado (no se encuentra dentro del objeto del producto), informa que el ingrediente no está disponible o no es aplicable y ofrece alternativas.",
