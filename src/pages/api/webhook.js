    ...
    relevantChatHistory.unshift({
      ...
      content: JSON.stringify({
        ...
        details: [
          ...
          "     - Pedido: una pizza grande mitad especial sin pepperoni pero con champiñón, y la otra mitad villa sin piña",
          "       - orderItems:",
          "         {",
          "           productId: 'PZ',",
          ...
          "             { pizzaIngredientId: 'PZI33', half: 'right', action: 'remove' }",
          "           ],",
          "           selectedModifiers: [],",
          "           comments: ''",
          "         }",
          "     - Pedido: una pizza chica especial sin chile morron y una pizza chica con relleno mitad adelita y mitad zapata",
          "       - orderItems:",
          "         {",
          "           productId: 'PZ',",
          ...
          "             { pizzaIngredientId: 'PZI31', half: 'left', action: 'remove' }",
          "           ],",
          "           selectedModifiers: [],",
          "           comments: ''",
          "         },",
