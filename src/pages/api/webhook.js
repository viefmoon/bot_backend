    ...
    relevantChatHistory.unshift({
      ...
      content: JSON.stringify({
        ...
        details: [
          ...
          "2. Pizzas:",
          "   - Ingredientes: ",
          "     - Pizza Especial: Pepperoni, Salchicha, Jamón, Salami, Chile morrón.",
          "     - Pizza Carnes Frías: Pepperoni, Salchicha, Jamón, Salami.",
          "     - Pizza Carranza: Chorizo, Jamón, Chile jalapeño, Jitomate.",
          "     - Pizza Zapata: Salami, Jamón, Champiñón.",
          "     - Pizza Villa: Chorizo, Tocino, Piña, Chile jalapeño.",
          "     - Pizza Margarita: 3 Quesos, Jitomate, Albahaca.",
          "     - Pizza Adelita: Jamón, Piña, Arándano.",
          "     - Pizza Hawaiana: Jamón, Piña.",
          "     - Pizza Mexicana: Chorizo, Cebolla, Chile jalapeño, Jitomate.",
          "     - Pizza Rivera: Elote, Champiñón, Chile morrón.",
          "     - Pizza Kahlo: Calabaza, Elote, Champiñón, Jitomate, Chile morrón.",
          "     - Pizza Lupita: Carne molida, Tocino, Cebolla, Chile morrón.",
          "     - Pizza Pepperoni: Pepperoni.",
          "     - Pizza La Leña: Tocino, Pierna, Chorizo, Carne molida.",
          "     - Pizza La María: Pollo BBQ, Piña, Chile jalapeño.",
          "     - Pizza Malinche: 3 Quesos, Queso de cabra, Champiñón, Jamón, Chile seco, Albahaca.",
          "     - Pizza Philadelphia: Queso philadelphia, Chile jalapeño, Jamón, Albahaca.",
          "     - Ingredientes individuales disponibles: 3 Quesos, Albahaca, Arándano, Calabaza, Cebolla, Champiñón, Chile seco, Chorizo, Elote, Chile jalapeño, Jamón, Jitomate, Carne molida, Chile morrón, Pierna, Piña, Pollo BBQ, Queso de cabra, Salami, Salchicha, Tocino.",
          "   - Ejemplos de pedidos de pizzas y su salida como orderItems:",
          "     - Pedido: una pizza grande mitad especial sin pepperoni pero con champiñón, y la otra mitad villa con salami",
          "       - orderItems:",
          "         {",
          "           productId: 'PZ',",
          "           productVariantId: 'PZV1',",
          "           quantity: 1,",
          "           selectedPizzaIngredients: [",
          "             { pizzaIngredientId: 'PZI1', half: 'left', action: 'add' },",
          "             { pizzaIngredientId: 'PZI13', half: 'left', action: 'remove' },",
          "             { pizzaIngredientId: 'PZI23', half: 'left', action: 'add' },",
          "             { pizzaIngredientId: 'PZI5', half: 'right', action: 'add' },",
          "             { pizzaIngredientId: 'PZI36', half: 'right', action: 'add' }",
          "           ],",
          "           selectedModifiers: [],",
          "           comments: ''",
          "         }",
          "     - Pedido: una pizza chica especial y una pizza chica con relleno mitad adelita y mitad zapata",
          "       - orderItems:",
          "         {",
          "           productId: 'PZ',",
          "           productVariantId: 'PZV3',",
          "           quantity: 1,",
          "           selectedPizzaIngredients: [",
          "             { pizzaIngredientId: 'PZI1', half: 'none', action: 'add' }",
          "           ],",
          "           selectedModifiers: [],",
          "           comments: ''",
          "         },",
          "         {",
          "           productId: 'PZ',",
          "           productVariantId: 'PZV6',",
          "           quantity: 1,",
          "           selectedPizzaIngredients: [",
          "             { pizzaIngredientId: 'PZI7', half: 'left', action: 'add' },",
          "             { pizzaIngredientId: 'PZI4', half: 'right', action: 'add' }",
          "           ],",
          "           selectedModifiers: [],",
          "           comments: ''",
          "         }",
          "   - Si el producto es una pizza se pueden crear hasta 2 mitades de una pizza, es obligatorio incluir selectedpizzaIngredients con mitad y accion de añadir o quitar, los ingredientes retirados y añadidos solo se añaden en selectedpizzaingredients, no en comentarios",
          "3. Comentarios:",
