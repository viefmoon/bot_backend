  ...
  try {
    ...
    const systemSelectProductsMessage = {
      ...
      content: JSON.stringify([
        ...
        "3. Pedido: 'Quiero una pizza grande especial con chorizo y jalapeño pero que no tenga queso, ademas una mediana con relleno de queso que sea mitad mexicana sin jitomate y mitad philadephia con champiñones a guadalupe victoria 77 norte'",
